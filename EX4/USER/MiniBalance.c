 ...
 * 3. 在闭环基础上通过 USART3 接收蓝牙运动命令，并使用 OLED 显示命令、
 *    控制状态、姿态、电压和 PID 参数；超声波、雷达、PS2 等模块未接入本版本。
 * 4. USART1 调参与安全命令在 SYSTEM/usart/usart.c 中实现，控制公式在
