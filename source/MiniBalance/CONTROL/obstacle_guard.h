...
/* 实车贴障：原 120+v*0.18 在 400mm/s 时约 192mm，停车几乎贴上。
 * 探头在车鼻后，刹车时车体前倾，再加 65ms 测距周期。
 * 提到 200+v*0.22，400mm/s 时约 288mm。 */
#define OBSTACLE_GUARD_STOP_BASE_MM          200U
#define OBSTACLE_GUARD_REACTION_MS           220U
#define OBSTACLE_GUARD_STOP_MAX_MM           360U
