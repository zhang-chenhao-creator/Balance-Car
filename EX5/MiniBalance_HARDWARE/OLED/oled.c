 ...
 *
 * This file only provides the basic drawing primitives:
 *   byte write -> point draw -> character/number/string draw -> GRAM refresh.
 *
 * The actual EX4 display pages are built in:
 *   MiniBalance/OLED_STATUS/oled_status.c
 */
...
返回  值：无
**************************************************************************/
/* Display an ASCII string with the 12x6 font. */
...
Input   : line: page index, 0--7
Output  : none
**************************************************************************/	 				    
/* Clear one 8-pixel page in the local GRAM buffer. The caller decides when to refresh. */
